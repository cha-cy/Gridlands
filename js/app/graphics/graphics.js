define(['jquery', 'app/eventmanager', 'app/textStore', 'app/gameoptions',
	...
	function drawSlot(slotInfo, slotIndex) {
		...
		if(slotInfo === 'empty') {
			...
			var day = Graphics.make('day').text(Graphics.getText('TIAN') +''+ slotInfo.day);
	...
	var Graphics = {
		...
		handleDayBreak: function(dayNumber) {
			...
			setTimeout(function() {
				notifier = $('<div>').addClass('dayNotifier').text(tian + " " + dayNumber + " " + txt).appendTo('.world');
			}, 1400);
			setTimeout(function() {
